    ...
    return (
      <div> <br/><br/>
        <div className='card col-md-6 offset-md-3'>
            <h3 className='text-center card-center'> View Employee Details </h3>
            ...
            <h3 className='text-center card-center'> View Department Details </h3>
            <div className='card-body'>
                <div className='row'>
            ...
            <h3 className='text-center card-center'> View Organization Details </h3>
            <div className='card-body'>
                <div className='row'>
